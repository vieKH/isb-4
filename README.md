...
В данной лабораторной работе вы поработаете с образом виртуального диска виртуальной машины, посмотрите его содержимое и попытаетесь подобрать пароли к пользователям виртуальной машины.
